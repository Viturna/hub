...
<header class:menu-open={menuOpen} class:hidden={!headerVisible}>
  ...
  <button class="menu-toggle no-bg" on:click={toggleMenu}>
    <svg width="30" height="21" viewBox="0 0 30 21" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M28.4167 8.83331H1.58333C0.708883 8.83331 0 9.5422 0 10.4166V10.5833C0 11.4578 0.708883 12.1666 1.58333 12.1666H28.4167C29.2911 12.1666 30 11.4578 30 10.5833V10.4166C30 9.5422 29.2911 8.83331 28.4167 8.83331Z" fill="#1B1B1B"/>
      <path d="M28.4167 17.1667H1.58333C0.708883 17.1667 0 17.8756 0 18.75V18.9167C0 19.7911 0.708883 20.5 1.58333 20.5H28.4167C29.2911 20.5 30 19.7911 30 18.9167V18.75C30 17.8756 29.2911 17.1667 28.4167 17.1667Z" fill="#1B1B1B"/>
      <path d="M28.4167 0.5H1.58333C0.708883 0.5 0 1.20888 0 2.08333V2.25C0 3.12445 0.708883 3.83333 1.58333 3.83333H28.4167C29.2911 3.83333 30 3.12445 30 2.25V2.08333C30 1.20888 29.2911 0.5 28.4167 0.5Z" fill="#1B1B1B"/>
    </svg>
  </button>
