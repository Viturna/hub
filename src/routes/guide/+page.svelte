    ...
    <div
      ...
      on:click={() =>
        openPopup(
          ...
          "Resto U' Le capu",
          "Comment y manger ? Voici chaque étape pour manger au Crous :",
          "Détails supplémentaires sur le resto U..."
        )}
    >
      <img src="/images/guide/crous.webp" alt="" class="illustration" />
      <p>Le resto U</p>
    ...
    <div
      ...
      on:click={() =>
        openPopup(
          ...
          "Autre titre",
          "Autre sous-titre",
          "Autres détails importants à savoir..."
        )}
    >
